...
public class OPHAnalysisVO {
	...
	public OPHAnalysisVO() {}
	
	public OPHAnalysisVO(String districtName, String analysisItem, double salePriceAvg, double jeonsePriceAvg, double monthlyDepositAvg, double monthlyAvg, double salePricePercentile, 	double jeonsePricePercentile, double monthlyDepositPercentile, 	double monthlyPercentile, String salePriceGrade, String jeonsePriceGrade, String monthlyDepositGrade, String monthlyGrade) {
